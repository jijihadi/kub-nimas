        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('hasil-produksi-update')."/".$main['id'] }}">
                                    @csrf
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input id="typeh" class="mt-1 form-control" autocomplete="off" name="nama_anggota"
                                            type="text" value="{{$main['nama_anggota']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="name" class="form-control" name="nilai" type="text" value="{{$main['nilai']}}">
                                        </div>
                                    </div>
