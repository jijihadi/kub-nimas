        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('list-anggota-update')."/".$main['id'] }}">
                                    @csrf
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input id="name" class="form-control" name="pendidikan" type="text" value="{{$main['pendidikan']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <select class="js-example-basic-single form-select" data-width="100%" name="usia">
                                            ...
                                            @for ($i = 17; $i < 90; $i++)
                                                <option {{($i==$main['usia'])?"selected":""}}>{{$i}}</option>
                                            @endfor
                                        </select>
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Usaha Utama</label>
                                        <input id="name" class="form-control" name="usaha_utama" type="text" value="{{$main['usaha_utama']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Usaha Sampingan</label>
                                        <input id="name" class="form-control" name="usaha_sampingan" type="text" value="{{$main['usaha_sampingan']}}">
                                        <p class="text-secondary"><i>Kosongi jika tidak ada</i></p>
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Jumlah Perahu</label>
                                        <input id="name" class="form-control" name="jumlah_perahu" type="number" value="{{$main['jumlah_perahu']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Jenis Alat</label>
                                        <input id="name" class="form-control" name="jenis_alat" type="text" value="{{$main['jenis_alat']}}">
                                        <p class="text-secondary"><i>Kosongi jika tidak ada</i></p>
                                    </div>
                                    <div class="mb-3 col-lg-12">
