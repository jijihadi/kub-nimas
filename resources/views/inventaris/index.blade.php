                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (cek_admin() == 1)
                                                                <!--Edit-->
                                                                <a
                                                                    href="{{ url('inventaris-barang-edit') . '/' . $row->id }}">
                                                                    <button type="button"
                                                                ...
                                                                <!--Delete-->
                                                                <a
                                                                    href="{{ url('inventaris-barang-delete') . '/' . $row->id }}">
                                                                    <button type="button"
                                ...
                                <div class="tab-pane fade" id="{{ makeclass($rows->name) }}" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTableExample{{ $i }}" class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @if (gettable('barangs', 'id_kub', $rows->id) > 0)
                                                    @foreach (gettable('barangs', 'id_kub', $rows->id) as $row)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>{{ $row->name }}</td>
                                                            <td>{{ $row->jumlah }}&nbsp;Buah</td>
