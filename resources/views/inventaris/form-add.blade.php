    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="signupForm" class="row" method="post" action="{{url('inventaris-barang-save')}}">
                            @csrf
                            @include('layouts.partial.alert')
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Kode Barang</label>
                                <input class="form-control" data-inputmask-alias="****-****" name="kode" inputmode="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input id="name" class="form-control" name="perolehan" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input id="name" class="form-control" name="kondisi" type="text">
                            </div>
