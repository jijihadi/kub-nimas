...
@section('content')
    <div class="page-content">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('inventaris-barang')}}">Inventaris</a></li>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('inventaris-barang-update')."/".$main['id'] }}">
                                    @csrf
                                    @include('layouts.partial.alert')
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Kode Barang</label>
                                        <input class="form-control" data-inputmask-alias="****-****" name="kode" inputmode="text" value="{{$main['kode']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Perolehan</label>
                                        <input id="name" class="form-control" name="perolehan" type="text" value="{{$main['perolehan']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Jumlah</label>
                                        <input id="name" class="form-control" name="jumlah" type="number" value="{{$main['jumlah']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Kondisi</label>
                                        <input id="name" class="form-control" name="kondisi" type="text" value="{{$main['kondisi']}}">
                                    </div>
