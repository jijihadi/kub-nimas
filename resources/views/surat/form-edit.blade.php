        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('surat-update')."/".$main['id'] }}">
                                    @csrf
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <select class="js-example-basic-single form-select" id="jenis" data-width="100%"
                                            ...
                                            <option value="1" {{ $main['perihal_keluar'] == '' ? 'selected' : '' }}>Masuk</option>
                                            <option value="2" {{ $main['perihal_keluar'] != '' ? 'selected' : '' }}>Keluar</option>
                                        </select>
                                        <input class="form-control" type="hidden" name="jenis" value="{{ $main['perihal_keluar'] == '' ? '1' : '2' }}" />
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="mb-3 col-lg-6 tg-in {{ $main['perihal_keluar'] != '' ? 'd-none' : '' }}">
                                        ...
                                        <div class="input-group date datepicker" id="datePickerExample2">
                                            <input type="text" class="form-control" name="tanggal_masuk" value="{{$main['tanggal_masuk']}}" />
                                            <span class="input-group-text input-group-addon"><i data-feather="calendar"></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-lg-6 tg-out {{ $main['perihal_keluar'] == '' ? 'd-none' : '' }}">
                                        <label for="name" class="form-label">Tanggal Keluar</label>
                                        <div class="input-group date datepicker" id="datePickerExample3">
                                            <input type="text" class="form-control" name="tanggal_keluar" value="{{$main['tanggal_keluar']}}" />
                                            <span class="input-group-text input-group-addon"><i data-feather="calendar"></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-lg-6 pr-in {{ $main['perihal_keluar'] != '' ? 'd-none' : '' }}">
                                        <label for="exampleFormControlTextarea1" class="form-label">Perihal Masuk</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="perihal_masuk" rows="3">{{$main['perihal_masuk']}}</textarea>
                                    </div>
                                    <div class="mb-3 col-lg-6 pr-out {{ $main['perihal_keluar'] == '' ? 'd-none' : '' }}">
                                        <label for="exampleFormControlTextarea1" class="form-label">Perihal Keluar</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="perihal_keluar" rows="3">{{$main['perihal_keluar']}}</textarea>
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Tindak Lanjut</label>
                                        <div class="input-group">
                                            <input class="form-control" id="tindak_lanjut" name="tindak_lanjut"  value="{{$main['tindak_lanjut']}}" />
                                        </div>
                                    </div>
                                    <div class="mb-3 col-lg-6">
