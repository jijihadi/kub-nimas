    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="signupForm" class="row" method="post" action="{{ url('rencana-kegiatan-save') }}">
                            @csrf
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <div class="input-group date timepicker" id="datetimepickerExample1" data-target-input="nearest">
                                    ...
                                    <input class="form-control datetimepicker-input" data-target="#datetimepickerExample1" name="waktu" type="text" />
                                </div>
                            </div>
