                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-6 ">
                                @if (cek_admin() == 1)
                                    <a href="{{ url('rencana-kegiatan-add') }}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (cek_admin() == 1)
                                                                <!--Edit-->
                                                                <a
                                                                    href="{{ url('rencana-kegiatan-edit') . '/' . $row->id }}">
                                                                    <button type="button"
                                                                ...
                                                                <!--Delete-->
                                                                <a
                                                                    href="{{ url('rencana-kegiatan-delete') . '/' . $row->id }}">
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-danger btn-icon-text"
                                                                        onclick="return confirm('Hapus data {{ $row->name }} pada tanggal {{ $row->waktu }}?');">
                                                                        <i class="btn-icon-prepend"
                                ...
                                <div class="tab-pane fade" id="{{ makeclass($rows->name) }}" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTableExample{{ $i }}" class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @if (gettable('rencanas', 'id_kub', $rows->id) > 0)
                                                    @foreach (gettable('rencanas', 'id_kub', $rows->id) as $row)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>{{ ucwords($row->name) }}</td>
                                                            <td>
