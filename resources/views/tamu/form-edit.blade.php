        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('buku-tamu-update')."/".$main['id'] }}">
                                    @csrf
                                    @include('layouts.partial.alert')
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Nama</label>
                                        <input id="name" class="form-control" name="nama" type="text" value="{{$main['nama']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <input class="form-control" maxlength="13" name="telp" id="defaultconfig-2"
                                            type="text" placeholder="Ex: 081122" value="{{$main['telp']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="name" class="form-label">Tanggal Datang</label>
                                        <div class="input-group date datepicker" id="datePickerExample">
                                            <input type="text" class="form-control" name="tanggal_datang" value="{{$main['tanggal_datang']}}">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <div class="input-group date datepicker" id="datePickerExample2">
                                            <input type="text" class="form-control" name="tanggal_pulang" value="{{$main['tanggal_pulang']}}">
                                            <span class="input-group-text input-group-addon"><i
                                                    data-feather="calendar"></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-lg-12">
                                        ...
                                        <input id="name" class="form-control" name="keperluan" type="text" value="{{$main['keperluan']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="exampleFormControlTextarea1" class="form-label">Kesan</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="kesan" rows="3">{{$main['kesan']}}</textarea>
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                        <label for="exampleFormControlTextarea1" class="form-label">Pesan</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="pesan" rows="3">{{$main['pesan']}}</textarea>
                                    </div>
