    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="signupForm" class="row" method="post" action="{{ url('daftar-hadir-save') }}">
                            @csrf
                            @include('layouts.partial.alert')
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Kegiatan</label>
                                <input id="typeh" class="mt-1 form-control" autocomplete="off" name="kegiatan" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input id="name" class="form-control" name="peserta" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
