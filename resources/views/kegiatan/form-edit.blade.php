        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        @if (!empty($main))
                                <form id="signupForm" class="row" method="post" action="{{ url('usaha-update')."/".$main['id'] }}">
                                    @csrf
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input id="name" class="form-control" name="pelaksana" type="text" value="{{$main['pelaksana']}}">
                                    </div>
                                    <div class="mb-3 col-lg-6">
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input id="name" class="form-control" name="hasil" type="text" value="{{$main['hasil']}}">
                                    </div>
                                    <div class="mb-3 col-lg-12">
