...
@section('content')
    <div class="page-content">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('usaha') }}">Kegiatan Usaha</a></li>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="signupForm" class="row" method="post" action="{{ url('usaha-save') }}">
                            @csrf
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="uraian" rows="3"></textarea>
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Volume</label>
                                <input id="name" class="form-control" name="volume" type="number">
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Pelaksana</label>
                                <input id="name" class="form-control" name="pelaksana" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Tempat</label>
                                <input id="name" class="form-control" name="tempat" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Hasil</label>
                                <input id="name" class="form-control" name="hasil" type="text">
                            </div>
                            <div class="mb-3 col-lg-12">
