    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form id="signupForm" class="row" method="post" action="{{url('notulen-save')}}">
                            @csrf
                            @include('layouts.partial.alert')
                            <div class="mb-3 col-lg-6">
                                <label for="name" class="form-label">Kegiatan</label>
                                <input id="name" class="form-control" name="kegiatan" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input id="name" class="form-control" name="pembicara" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input id="name" class="form-control" name="materi" type="text">
                            </div>
                            <div class="mb-3 col-lg-6">
                                <label for="exampleFormControlTextarea1" class="form-label">Kesimpulan</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="kesimpulan" rows="3"></textarea>
                            </div>
